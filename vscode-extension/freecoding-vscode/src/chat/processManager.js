/**
 * ProcessManager — spawns FreeCoding in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The freecoding binary (e.g. 'freecoding')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'freecoding';
