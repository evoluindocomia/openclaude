...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to FreeCoding now.</p>
    <p>FreeCoding will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in FreeCoding.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in FreeCoding.</p>
  </body>
</html>`
}
