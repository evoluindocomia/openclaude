 ...
 *
 * Usage:
 *   freecoding --provider openai --model gpt-4o
 *   freecoding --provider gemini --model gemini-2.0-flash
 *   freecoding --provider mistral --model ministral-3b-latest
 *   freecoding --provider ollama --model llama3.2
 *   freecoding --provider anthropic   (default, no-op)
 */
