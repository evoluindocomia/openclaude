# Contributing to FreeCoding

Thanks for contributing.

FreeCoding is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/evoluindocomia/affhub-freecoding/issues) and [discussions](https://github.com/evoluindocomia/affhub-freecoding/discussions) before opening a new thread.
...
FreeCoding supports multiple provider paths. If you change provider logic:
