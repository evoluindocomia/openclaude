...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/freecoding.proto')
...
const freecodingProto = protoDescriptor.freecoding.v1
...
async function main() {
  ...
  const client = new freecodingProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mFreeCoding gRPC CLI\x1b[0m')
