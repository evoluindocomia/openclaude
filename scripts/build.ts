/**
 * FreeCoding build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.PACKAGE_URL': JSON.stringify('@evoluindocomia/affhub-freecoding'),
...
if (!result.success) {
  ...
  console.log(`✓ Built freecoding v${version} → dist/cli.mjs`)
}
