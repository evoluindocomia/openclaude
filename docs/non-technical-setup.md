# FreeCoding for Non-Technical Users
...
## What FreeCoding Does

FreeCoding lets you use an AI coding assistant with different model providers such as:
...
After you run `freecoding`, the CLI should start and wait for your prompt.
