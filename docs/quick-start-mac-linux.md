# FreeCoding Quick Start for macOS and Linux
...
## 6. Updating FreeCoding

```bash
npm install -g @evoluindocomia/affhub-freecoding@latest
```

## 7. Uninstalling FreeCoding

```bash
npm uninstall -g @evoluindocomia/affhub-freecoding
```
